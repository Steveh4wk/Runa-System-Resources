...
client_scripts {
    ...
    'client/animagus_client.lua',    -- gestione Animagus
...
exports {
    ...
    'TransformToAnimal',      -- trasformazione animale
    'RestoreHumanForm',       -- ripristino forma umana
    'GetCurrentAnimal'         -- animale corrente
}
