...
-- Tamed animals storage (empty since we removed tamed.json)
local Tamed = {}
...
local function saveAnimals()
    -- Skip saving since we removed animals.json file
    print("[Animal Farm] Skipping animal data saving - using spawn system only")
end

local function saveTamed()
    -- Skip saving since we removed tamed.json file
    print("[Animal Farm] Skipping tamed data saving - using spawn system only")
end

local function loadAnimals()
    -- Skip loading since we removed animals.json file
    print("[Animal Farm] Skipping animal data loading - using spawn system only")
    Animals = {}
end

local function loadTamed()
    -- Skip loading since we removed tamed.json file
    print("[Animal Farm] Skipping tamed data loading - using spawn system only")
    Tamed = {}
end
