...
-- 16% chance of receiving common item.
Config.CommonChance = 16

-- 90% chance of receiving rare item.
Config.RareChance = 90
...
-- list of common items detectable - Solo Rune Base e +1
Config.CommonItems = {
    'runa_hp',
    'runa_hp_1',
    'runa_danno',
...
-- list of rare items detectable - Sistema Premium
Config.RareItems = {
    'galeoni',
    'pietra_grezza',
    'orologiostellare',
...
Config.DetectZones = {
    ...
    [2] = {
        ...
        zones = {
            ...
            vector2(-2057.0686035156, -503.62591552744),
